...
# Для сервера я их добавил, тебе надо на комп установить 2 библиотеки, на который он жалуется
# Также тебе надо будет установить определенною версию Хрома для запуска кода
# Узнай, какая у тебя версия на компе и скачай эмулятор отсюда https://chromedriver.chromium.org/downloads
